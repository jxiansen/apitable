...
import { ICalendarViewProperty, ISetCalendarStyle, ISnapshot } from '../exports/store/interfaces';
...
export class ViewAction {
   ...
   */
  static setGalleryStyle2Action = (snapshot: ISnapshot, payload: ISetGalleryStyle): IJOTAction | null => {
  ...
  static setViewStyle2Action = (snapshot: ISnapshot, payload: ISetKanbanStyleValue & { viewId: string }): IJOTAction | null => {
    const { viewId, styleKey, styleValue } = payload;
  ...
  static setOrgChartStyle2Action = (snapshot: ISnapshot, payload: ISetOrgChartStyle): IJOTAction | null => {
    const { viewId, styleKey, styleValue } = payload;

...
export const createSimpleContextWrapper = (context?: Partial<IWidgetContext> & { mockWidgetSdkData?: MockWidgetSdkData }): IWidgetContext => {
  ...
  const { id = widgetId!, locale = 'zh-CN', theme = ThemeName.Light, widgetStore = _widgetStore } = context || {};

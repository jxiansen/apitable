...
import { handleCreateNewTrigger, useColumnInfo } from 'pc/components/robot/robot_detail/create_new_trigger/create_new_trigger';
...
export const ReadonlyFieldColumn: FC<{
  ...
  if (fieldItem == null) {
    return (
      <PointerCursorBox
        height={'40px'}
        borderColor={colors.textDangerDefault}
        cursor={'default'}
        paddingLeft={'8px'}
        paddingRight={'8px'}
        borderWidth={'1px'}
        ...
        borderRadius={'4px'}
      >
        <Box display={'inline-flex'} alignItems={'center'} height={'100%'} cursor={'default'} width={'100%'} justifyContent={'flex-start'}>

...
describe('figma url convert', () => {
  test('The link copied directly from the URL.', () => {
    const url =
      'https://www.figma.com/file/VhZDEoWkElBsboE85XKShv/%E3%80%90%E5%B7%A5%E4%BD%9C%E5%8F%B0%E3%80%91%E5%B5%8C%E5%85%A5-URL-%E8%8A%82%E7%82%B9?type=design&node-id=0-1&mode=design&t=P2gz6pps5mdQqRA3-0';
    const afterConvert = convertFigmaUrl(url);

    expect(afterConvert).toBe(

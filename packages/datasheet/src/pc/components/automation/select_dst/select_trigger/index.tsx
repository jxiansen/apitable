...
> = ({ value, label, variant, onClick, placeholder }) => {
  ...
  return (
    <StyledSelectTrigger id={'AUTOMATION_BOUND_DATASHEET'} disabled={false} onClick={onClick} focus={false} tabIndex={-1} data-name="select">
      <StyledSelectedContainer className={'ellipsis'}>
        {label != '' && label != null && (

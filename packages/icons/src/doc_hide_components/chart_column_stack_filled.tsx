...
export const ChartColumnStackFilled: React.FC<IIconProps> = makeIcon({
  Path: ({ colors }) => (
    <>
      <path
        d="M23 41H13C12.4477 41 12 41.4477 12 42V67C12 67.5523 12.4477 68 13 68H23C23.5523 68 24 67.5523 24 67V42C24 41.4477 23.5523 41 23 41Z"
        fill={colors[2]}
      />
  ...
  colorful: true,
  allPathData: [
    'M23 41H13C12.4477 41 12 41.4477 12 42V67C12 67.5523 12.4477 68 13 68H23C23.5523 68 24 67.5523 24 67V42C24 41.4477 23.5523 41 23 41Z',
    'M12 60H24V67C24 67.5523 23.5523 68 23 68H13C12.4477 68 12 67.5523 12 67V60Z',
    'M24 48H12V60H24V48Z',

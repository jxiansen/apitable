...
export const InviteSmallFilled: React.FC<IIconProps> = makeIcon({
  Path: ({ colors }) => (
    <>
      ...
      <path
        d="M13.5 4H2.5C1.67157 4 1 4.67157 1 5.5C1 6.32843 1.67157 7 2.5 7H13.5C14.3284 7 15 6.32843 15 5.5C15 4.67157 14.3284 4 13.5 4Z"
        fill={colors[4]}
      />
  ...
  colorful: true,
  allPathData: [
    'M2 6H14V13C14 14.1046 13.1046 15 12 15H4C2.89543 15 2 14.1046 2 13V6Z',
    'M9 8H7V15H9V8Z',
    'M7 3V4C7 4.33333 6.6 5 5 5C3 5 3 3.5 3 3C3 2.5 3.5 1 4.5 1C5.3 1 6.5 2.33333 7 3Z',
    'M2 6H14V8H2V6Z',
    'M9 3V4C9 4.33333 9.4 5 11 5C13 5 13 3.5 13 3C13 2.5 12.5 1 11.5 1C10.7 1 9.5 2.33333 9 3Z',
    'M11 5C12.6 5 13 4.5 13 3C13 2.66667 12.8 2 12 2C11.2 2 9.66667 3.33333 9 4C9 4.33333 9.4 5 11 5Z',
    'M5 5C3.4 5 3 4.5 3 3C3 2.66667 3.2 2 4 2C4.8 2 6.33333 3.33333 7 4C7 4.33333 6.6 5 5 5Z',
    'M13.5 4H2.5C1.67157 4 1 4.67157 1 5.5C1 6.32843 1.67157 7 2.5 7H13.5C14.3284 7 15 6.32843 15 5.5C15 4.67157 14.3284 4 13.5 4Z',
    'M9 4H7V7H9V4Z',
    'M9 8H7V7H9V8Z',
    'M9 3H7V4H9V3Z',
  ],

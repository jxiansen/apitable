...
export const MiddlescreenOutlined: React.FC<IIconProps> = makeIcon({
  Path: ({ colors }) => (
    <>
      <path
        d="M4.75 5.25C4.47386 5.25 4.25 5.47386 4.25 5.75V10.25C4.25 10.5261 4.47386 10.75 4.75 10.75H11.25C11.5261 10.75 11.75 10.5261 11.75 10.25V5.75C11.75 5.47386 11.5261 5.25 11.25 5.25H4.75Z"
        fill={colors[0]}
      />
      <path
  ...
  colorful: false,
  allPathData: [
    'M4.75 5.25C4.47386 5.25 4.25 5.47386 4.25 5.75V10.25C4.25 10.5261 4.47386 10.75 4.75 10.75H11.25C11.5261 10.75 11.75 10.5261 11.75 10.25V5.75C11.75 5.47386 11.5261 5.25 11.25 5.25H4.75Z',

...
export const MoreOutlined: React.FC<IIconProps> = makeIcon({
  ...
  colorful: false,
  allPathData: [
    'M2.5 9.5C3.32843 9.5 4 8.82843 4 8C4 7.17157 3.32843 6.5 2.5 6.5C1.67157 6.5 1 7.17157 1 8C1 8.82843 1.67157 9.5 2.5 9.5Z',
    ...
    'M15 8C15 8.82843 14.3284 9.5 13.5 9.5C12.6716 9.5 12 8.82843 12 8C12 7.17157 12.6716 6.5 13.5 6.5C14.3284 6.5 15 7.17157 15 8Z',
  ],
  width: '16',
  height: '16',
  viewBox: '0 0 16 16',

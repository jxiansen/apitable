...
export const SidescreenOutlined: React.FC<IIconProps> = makeIcon({
  Path: ({ colors }) => (
    <>
      <path
        d="M10 4.5C9.72386 4.5 9.5 4.72386 9.5 5V11C9.5 11.2761 9.72386 11.5 10 11.5H12C12.2761 11.5 12.5 11.2761 12.5 11V5C12.5 4.72386 12.2761 4.5 12 4.5H10Z"
        fill={colors[0]}
      />
      <path
  ...
  colorful: false,
  allPathData: [
    'M10 4.5C9.72386 4.5 9.5 4.72386 9.5 5V11C9.5 11.2761 9.72386 11.5 10 11.5H12C12.2761 11.5 12.5 11.2761 12.5 11V5C12.5 4.72386 12.2761 4.5 12 4.5H10Z',

...
export const DocumentOperateRo = {
  ...
  fromJSON(object: any): DocumentOperateRo {
    return {
      removeDocumentNames: Array.isArray(object?.removeDocumentNames) ? object.removeDocumentNames.map((e: any) => String(e)) : [],
      recoverDocumentNames: Array.isArray(object?.recoverDocumentNames) ? object.recoverDocumentNames.map((e: any) => String(e)) : [],

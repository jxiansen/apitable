...
export class InternalServiceNodeInterfaceService {
  ...
  public getContainsStatus(folderId: string, nodeId: string): Observable<any> {
    ...
    // ];
    return this.httpClient.get<ResponseDataBoolean>(
      `${this.basePath}/internal/folders/${encodeURIComponent(String(folderId))}/nodes/${encodeURIComponent(String(nodeId))}/exists`,
      {

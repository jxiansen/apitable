...
export const TypographyBase = styled.div.attrs(applyDefaultTheme)<
  Required<ITypographyProps> & {
    cssTextOverflow: boolean;
    cssLineClamp: boolean;
    rows: number;
  }
>`
  margin: 0;

...
export const SearchSelect: FunctionComponent<ISearchSelectProps> = forwardRef<IDropdownControl, ISearchSelectProps>(
  ({ list, clazz, disabled = false, onChange, options, children, value }, ref) => {
    ...
    return (
      ...
      >
        {({ toggle }) => (
          <StyledListContainer width={'auto'} minWidth={options?.minWidth ?? 'auto'}>
            <ListDeprecate

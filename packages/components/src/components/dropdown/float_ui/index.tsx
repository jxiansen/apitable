import { cloneElement, isValidElement, ReactElement, useCallback, useEffect, useRef, useState } from 'react';
...
export const Dropdown = forwardRef<IDropdownControl, IDropdownProps>((props, ref) => {
  ...
  const { getReferenceProps, getFloatingProps } = useInteractions([...(options?.disableClick === true ? [] : [click]), dismiss, role]);

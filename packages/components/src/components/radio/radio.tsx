...
export const Radio = React.forwardRef(
  ({ children, name, checked, onChange, readOnly, value, ...restProps }: IRadio, ref: React.Ref<HTMLLabelElement>) => {
    ...
    return (
      ...
      >
        ...
        <RadioTextStyled className="radio-text">{children}</RadioTextStyled>
      </RadioLabelStyled>
    );
  }
);
